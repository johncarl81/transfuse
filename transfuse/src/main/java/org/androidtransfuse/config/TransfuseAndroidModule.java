...
@BindProviders({
        ...
        @BindProvider(type = Manifest.class, provider = ManifestThrowingProvider.class, scope = ConfigurationScope.class/*, named = @Named(TransfuseAndroidModule.ORIGINAL_MANIFEST)*/),
        @BindProvider(type = FileProxy.class, provider = FileThrowingProvider.class, scope = ConfigurationScope.class/*, named = @Named(TransfuseAndroidModule.MANIFEST_FILE)*/),

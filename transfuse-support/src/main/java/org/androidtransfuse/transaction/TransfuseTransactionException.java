...
public class TransfuseTransactionException extends RuntimeException {
    ...
    public TransfuseTransactionException(String message) {
        super(message);
    }

    public TransfuseTransactionException(String message, Throwable cause) {
        super(message, cause);
    }

    public TransfuseTransactionException(Throwable cause) {
        super(cause);
    }
}

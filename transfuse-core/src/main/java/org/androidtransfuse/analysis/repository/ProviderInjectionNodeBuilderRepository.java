...
public class ProviderInjectionNodeBuilderRepository {
    ...
    private final Map<ASTType, ASTType> providerInjectionNodeBuilders = new HashMap<ASTType, ASTType>();

    public void addProvider(ASTType astType, ASTType providerInjectionNodeBuilder) {
        providerInjectionNodeBuilders.put(astType, providerInjectionNodeBuilder);
    }

    public ASTType getProvider(ASTType astType) {

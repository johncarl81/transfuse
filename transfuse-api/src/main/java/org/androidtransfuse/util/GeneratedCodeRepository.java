...
public abstract class GeneratedCodeRepository<T> {
    ...
    public T get(Class clazz){
        ...
        if (result == null) {
            ...
            if(value == null){
                throw new TransfuseRuntimeException("Unable to find generated " +
                                                    getGeneratedTypeName() + " class for " + clazz +
                                                    ", verify that your class is configured properly and that the " +
                                                    getGeneratedTypeName() +
                                                    " generated class " +
                                                    getGeneratedClassName(clazz) +
    ...
    public abstract String getGeneratedClassName(Class clazz);

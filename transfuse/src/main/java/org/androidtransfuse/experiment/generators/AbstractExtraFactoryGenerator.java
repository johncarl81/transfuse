...
public abstract class AbstractExtraFactoryGenerator implements Generation {
    ...
    public AbstractExtraFactoryGenerator(ClassGenerationUtil generationUtil, UniqueVariableNamer namer, BundlePropertyBuilderRepository repository, ParcelerPropertyBuilder parcelerPropertyBuilder) {
                ...
                try {
                    ...
                    for (IntentFactoryExtraAspect extraAspect : extras) {
                        if (extraAspect.isRequired()) {
                            ...
                            JMethod setterMethod = factoryClass.method(JMod.PUBLIC, factoryClass, "set" + StringUtil.upperFirst(extraAspect.getName()));

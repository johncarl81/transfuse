...
Transfuse implements http://www.jcp.org/en/jsr/detail?id=330[JSR-330], the same standard many of the leading DI frameworks implement.  The following annotations are available:

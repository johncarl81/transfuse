 ...
 */
public class ScopeReferenceInjectionNodeBuilder implements InjectionNodeBuilder {
    ...
    @Inject
    public ScopeReferenceInjectionNodeBuilder(ASTType scopeAnnotation,
                                              Analyzer analyzer,
    ...
    public InjectionNode buildInjectionNode(InjectionSignature signature, AnalysisContext context) {
        ...
        injectionNode.addAspect(VariableBuilder.class, scopeReferenceInjectionFactory.buildVariableBuilder(scopeAnnotation));

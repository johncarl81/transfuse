...
public class PackageClassTest {
    ...
    public void testClassInput() {
        ...
        assertEquals(PackageClassTest.class.getSimpleName(), packageClass.getClassName());
        assertEquals(PackageClassTest.class.getPackage().getName(), packageClass.getPackage());
        assertEquals(PackageClassTest.class.getCanonicalName(), packageClass.getCanonicalName());
    }
    ...
    public void testInnerClassInput() {
        ...
        assertEquals(PackageClassTest.Inner$Stuff.class.getName(), packageClass.getFullyQualifiedName());
        assertEquals(PackageClassTest.class.getSimpleName() + "$" + PackageClassTest.Inner$Stuff.class.getSimpleName(), packageClass.getClassName());
        assertEquals(PackageClassTest.Inner$Stuff.class.getPackage().getName(), packageClass.getPackage());
        assertEquals(PackageClassTest.Inner$Stuff.class.getCanonicalName(), packageClass.getCanonicalName());
    }
